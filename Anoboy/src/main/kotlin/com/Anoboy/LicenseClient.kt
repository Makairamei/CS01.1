...
object LicenseClient {
    ...
    data class SelectorConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("iframe_fallback_attr") val iframeFallbackAttr: String = "",
        @com.fasterxml.jackson.annotation.JsonProperty("iframe_second_fallback_attr") val iframeSecondFallbackAttr: String = "",
        @com.fasterxml.jackson.annotation.JsonProperty("upload_selector") val uploadSelector: String = "",
        @com.fasterxml.jackson.annotation.JsonProperty("batch_selector") val batchSelector: String = "",
        @com.fasterxml.jackson.annotation.JsonProperty("data_video_selector") val dataVideoSelector: String = "",
        @com.fasterxml.jackson.annotation.JsonProperty("data_attr_selector") val dataAttrSelector: String = "",
